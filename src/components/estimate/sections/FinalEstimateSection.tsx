...
export function FinalEstimateSection({ 
  ...
  return (
    <section className="py-12 animate-fade-in">
      ...
      {/* Main cost card */}
      <div className="p-6 rounded-2xl bg-gradient-to-br from-primary to-primary/80 text-primary-foreground mb-6 animate-scale-in">
        <div className="flex items-center justify-between mb-4">
          <span className="text-sm opacity-90">Your cost after grant</span>
          <div className="flex items-center gap-2 bg-white/20 rounded-full px-3 py-1">
            <Gift className="w-4 h-4" />
            <span className="text-sm">£{grant.toLocaleString()} grant applied</span>
          </div>
        </div>
        <p className="text-5xl font-bold mb-2">£{netCost.toLocaleString()}</p>
      ...
      {/* Savings card */}
      <div className={cn(
        'p-5 rounded-2xl border mb-6 animate-scale-in',
        savingsPositive 
      ...
      {/* What happens next */}
      <div className="p-5 rounded-2xl bg-muted/30 border border-border mb-8">
